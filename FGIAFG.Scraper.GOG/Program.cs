...
internal class Program
{
    public static async Task Main(string[] args)
    {
        ...
        builder.Services.AddTransient<GoodOldGamesScraper>();
        builder.Services.AddHttpClient("gog", (_, client) => { client.BaseAddress = new Uri("https://www.gog.com"); });
